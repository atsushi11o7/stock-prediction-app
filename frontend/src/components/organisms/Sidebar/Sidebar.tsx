...
type Item = { href: string; label: string; icon: React.ComponentProps<typeof NavItem>["icon"] };
...
export default function Sidebar({
    ...
    return (
        ...
        <div className="pt-5 pb-3">
            <div className="mx-auto flex flex-col items-center space-y-3" style={contentStyle}>
        ...
        <nav className="flex-1 overflow-y-auto pb-4">
            ...
            {items.map((it) => (
                ...
                <NavItem href={it.href} label={it.label} icon={it.icon} size="md" />
                </li>
            ))}
            </ul>
        </nav>
